...
defOnce("Samples.App.MessageClient", function() {
    function MessageServer () {
        // Inherit the OF.Core application
        OF.Core.inherits(OF.Core.App, this, "Sample Message Client");

        // Setup Message Server Property
        var messageServer = new OF.Servers.MessageServer('client');
